...
import darkLogo from "../assets/descarga.png";
...
const Signin = () => {
  ...
  return (
    <div className="w-full bg-gray-100">
      <div className="w-full  pb-10 h-[80vh]">
        {successMsg ? (
          <div className="w-full flex justify-center items-center py-32">
            <p
              className="border-[1px] border-green-600 
            text-green-500 font-titleFont 
          ...
          <form className="w-[350px] mx-auto flex flex-col items-center">
            ...
            <div className="w-full border border-zinc-200 p-6">
              ...
              <div className="flex flex-col gap-3">
                ...
                border-zinc-400 px-2 text-base rounded-sm 
                outline-none focus-within:border-[#e77600] 
                ...
                font-semibold tracking-wide flex items-center gap-2 -mt-1.5"
                    >
            ...
            rounded-sm bg-gradient-to-t from-[#f7dfa5] 
            to-[#f0c14b] hover:bg-gradient-to-b border 
        ...
        rounded-sm bg-gradient-to-t from-slate-200 
        to-slate-100 hover:bg-gradient-to-b 
      ...
      via-white to-zinc-200 h-20 flex flex-col gap-4 justify-center items-center py-10"
      >
